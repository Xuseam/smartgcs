...
app.post('/api/classify', app.upload.single('images_file'), function(req, res) {
  ...
  console.log('*** test post classify start');
  var params = {
    url: null,
    images_file: null
  };
  ...
  var methods = [];
  console.log('*** process.env.OVERRIDE_CLASSIFIER_ID',process.env.OVERRIDE_CLASSIFIER_ID);
  console.log('*** req.body.classifier_id',req.body.classifier_id);
